...
let%expect_test "testConditionnelleOpt1" =
  runtam (pathFichiersRat^"testConditionnelleOpt1.rat");
  [%expect{| 5 |}]

let%expect_test "testConditionnelleOpt2" =
  runtam (pathFichiersRat^"testConditionnelleOpt2.rat");
  [%expect{| true |}]

let%expect_test "testConditionnelleOpt3" =
  runtam (pathFichiersRat^"testConditionnelleOpt3.rat");
  [%expect{| 0246810 |}]

let%expect_test "testConditionnelleTer1" =
  runtam (pathFichiersRat^"testConditionnelleTer1.rat");
  [%expect{| true |}]

let%expect_test "testConditionnelleTer2" =
  runtam (pathFichiersRat^"testConditionnelleTer2.rat");
  [%expect{| true |}]

let%expect_test "testConditionnelleTer3" =
  runtam (pathFichiersRat^"testConditionnelleTer3.rat");
  [%expect{| true |}]
