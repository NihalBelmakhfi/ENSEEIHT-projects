...
let%test_unit "testPointeur5" =
  ...
  | IdentifiantNonDeclare("pa") -> ()
  
let%test_unit "testConditionnelleOpt1" = 
  let _ = compiler (pathFichiersRat^"testConditionnelleOpt1.rat") in ()

let%test_unit "testConditionnelleOpt2" = 
  let _ = compiler (pathFichiersRat^"testConditionnelleOpt2.rat") in ()

let%test_unit "testConditionnelleOpt3" = 
  let _ = compiler (pathFichiersRat^"testConditionnelleOpt3.rat") in ()

  let%test_unit "testConditionnelleTer1" = 
  let _ = compiler (pathFichiersRat^"testConditionnelleTer1.rat") in ()

let%test_unit "testConditionnelleTer2" = 
  let _ = compiler (pathFichiersRat^"testConditionnelleTer2.rat") in ()

let%test_unit "testConditionnelleTer3" = 
  let _ = compiler (pathFichiersRat^"testConditionnelleTer3.rat") in ()
