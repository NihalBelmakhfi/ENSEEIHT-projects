...
(* Structure d'un affectable Rat*)
type affectable =
  (*Accéder à un identifiant par son nom de type string*)
  |Ident of string
  (*Déréférencement ou accés à un pointeur*)
  |Dereferencement of affectable
...
type expression =
  ...
  (* Définir un nouveau pointeur *)
  | New of typ
  (* Adresse d'un pointeur *)
  | Adresse of string
  (* La valeur null d'un pointeur *)
  | Null
  (* Conditionnelle ternaire sous forme d'opérateur ternaire*)
  | ConditionnelleTer of expression * expression * expression
...
and instruction =
  ...
  (* Conditionnelle optionnelle représentée par la condition, le bloc then sans le bloc else *)
